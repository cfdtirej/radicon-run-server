...
#            animation.save('basic_animation.gif', writer='imagemagick')
    ...
    def final_plot(self, path_x, path_y, Nodes_posi, samples, goal, obstacles, final_path):
...
def main(car_id, timestamp, sokuchi_x, sokuchi_y):
    ...
    # pathmake
    goal = [35.0, 4.0]
    init = [sokuchi_x, sokuchi_y]
    obstacles = np.array([[5, 1, 1],[15, 3, 1],[15, 2, 1],[15, 1, 1],[25, 4, 1],[25, 3, 1],[25, 2, 1]])
    ...
    for i in final_path:
        # xa = (i[0])
        # ya = (i[1])
        a, b = sokuchi_field.field_sokuchi(i[0],i[1])
        i[0] = a
        i[1] = b
    # print(final_path)
    ...
    # with open('C:/Users/ba-sa/Desktop/電柱IoT/create_server/testpy/population.json', 'w') as f:
    ...
    # figure.final_plot(path_x, path_y, Nodes, samples, goal, obstacles, final_path)
